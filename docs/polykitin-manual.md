...
thirteen columns, one for each input Kit has, by eight rows, one per
instrument. Where a polyphonic cable into Kit says "channel N is instrument
...
X, Y, SIZE, TENSION, MATERIAL, AIR, DECAY, TONE, EXCITER, MUFFLE. The rows are
